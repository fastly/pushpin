...
static Variant getChild(const Variant &in, const QString &parentName, const QString &childName,
...
static QString getString(const Variant &in, const QString &parentName, const QString &childName,
                         bool required, bool *ok = 0, QString *errorMessage = 0) {
    bool ok_;

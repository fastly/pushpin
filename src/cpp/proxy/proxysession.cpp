...
public:
	...
	Connection pausedRSConnection;
	Connection errorRespondingRSConnection;
	Connection headerBytesSentRSConnection;
	Connection bodyBytesSentRSConnection;
	Connection bytesWrittenRSConnection;
	...
	void add(RequestSession *rs)
	{
		...
		bytesWrittenRSConnection = rs->bytesWritten.connect(boost::bind(&Private::rs_bytesWritten, this, boost::placeholders::_1, rs));
		errorRespondingRSConnection = rs->errorResponding.connect(boost::bind(&Private::rs_errorResponding, this, rs));
		finishedRSConnection = rs->finished.connect(boost::bind(&Private::rs_finished, this, rs));
		pausedRSConnection = rs->paused.connect(boost::bind(&Private::rs_paused, this, rs));
		headerBytesSentRSConnection = rs->headerBytesSent.connect(boost::bind(&Private::rs_headerBytesSent, this, boost::placeholders::_1, rs));
		bodyBytesSentRSConnection = rs->bodyBytesSent.connect(boost::bind(&Private::rs_bodyBytesSent, this, boost::placeholders::_1, rs));

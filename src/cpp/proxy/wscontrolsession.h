...
public:
    ...
    boost::signals2::signal<void(int, const QByteArray&)> closeEventReceived;
    boost::signals2::signal<void()> detachEventReceived;
    boost::signals2::signal<void()> cancelEventReceived;

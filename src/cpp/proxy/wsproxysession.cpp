...
public:
	...
	~Private()
	{
		...
		connectedOutConnection.disconnect();
		readyReadOutConnection.disconnect();
		writeBytesChangedOutConnection.disconnect();
		peerClosedOutConnection.disconnect();
		closedOutConnection.disconnect();
		errorOutConnection.disconnect();
		readyReadInConnection.disconnect();
		framesWrittenInConnection.disconnect();
		writeBytesChangedInConnection.disconnect();
		peerInClosedInConnection.disconnect();
		closedInConnection.disconnect();
		errorInConnection.disconnect();

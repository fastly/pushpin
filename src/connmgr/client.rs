...
impl Connections {
    ...
    fn add(
        ...
        zreceiver_sender: Option<
            channel::LocalSender<(memorypool::Rc<zhttppacket::OwnedRequest>, usize)>,
        >,
        shared: Option<memorypool::Rc<StreamSharedData>>,
        polled: Option<memorypool::Rc<PolledFlag>>,
    ) -> Result<usize, ()> {
    ...
    fn try_send(
        &self,
        ckey: usize,
        value: (memorypool::Rc<zhttppacket::OwnedRequest>, usize),
    ) -> Result<(), mpsc::TrySendError<(memorypool::Rc<zhttppacket::OwnedRequest>, usize)>> {
        let nkey = ckey;
...
impl Worker {
    ...
    async fn stream_handle_task(
        ...
        let stream_polled_mem = memorypool::RcMemoryPool::new(conns.max());
                        ...
                        Ok(ret) => {
                            ...
                            let ckey = conns
                                .add(
                                    ...
                                    Some(memorypool::Rc::clone(&polled)),
                                )
                                .unwrap();
                    ...
                    Select6::R6(result) => match result {
                        Ok(msg) => {
                            ...
                            for (i, rid) in ids.iter().enumerate() {
                                ...
                                match conns.try_send(key, (memorypool::Rc::clone(&zreq), i)) {
                                    Ok(()) => {
    ...
    async fn stream_connection_task(
        ...
        tls_config_cache: Arc<TlsConfigCache>,
        pool: Arc<ConnectionPool>,
        zreceiver: channel::LocalReceiver<(memorypool::Rc<zhttppacket::OwnedRequest>, usize)>,
        deny: Rc<Vec<IpNet>>,
        conns: Rc<Connections>,
        origindman: Option<Arc<origind::OrigindManager>>,
        opts: ConnectionOpts,
...
pub mod tests {
    ...
    #[test]
    fn test_task_sizes() {
        // Sizes in debug mode at commit 08464e1c52dd12e76681c218b2681d00f1eb3712

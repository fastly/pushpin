...
public:
	...
	StatsManager(int connectionsMax, int subscriptionsMax, int workerIndex = 0, QObject *parent = 0);
	~StatsManager();
	...
	void incCounter(const QByteArray &routeId, Stats::Counter c, quint32 count = 1, const QString &domain = QString());

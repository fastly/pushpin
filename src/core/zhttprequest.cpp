...
Variant ZhttpRequest::passthroughData() const { return d->passthrough; }
...
void ZhttpRequest::setBackendData(const QString &data) { d->backendData = data; }
...
void ZhttpRequest::setPassthroughData(const Variant &data) { d->passthrough = data; }

...
cp -a .gitignore CHANGELOG.md configure COPYING corelib doc examples handler m2adapter proxy pushpin pushpin.pro pushpin.qc README.md runner tools build/pushpin-$VERSION
